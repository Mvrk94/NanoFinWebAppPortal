...
(function (e) {
    ...
    e.fn.vectorMap = function (e) {
        ...
        if (e === "addMap") jvm.WorldMap.maps[arguments[1]] = arguments[2];
            ...
            e = e ||
            {}, e.container = this, n = new jvm.WorldMap(e)
        }
        return this
    }
})(jQuery),
...
jvm.$ = jQuery, jvm.AbstractElement = function (e, t) {
    ...
    this.style = n ||
    {}, this.style.current = {}, this.isHovered = !1, this.isSelected = !1, this.updateStyle()
    ...
    var n;
    e = e ||
    {}, e.attribute = e.attribute || "fill", this.elements = t, this.params = e, e.attributes && this.setAttributes(e.attributes), jvm.$.isArray(e.scale) ? (n = e.attribute === "fill" || e.attribute === "stroke" ? jvm.ColorScale : jvm.NumericScale, this.scale = new n(e.scale, e.normalizeFunction, e.min, e.max)) : e.scale ? this.scale = new jvm.OrdinalScale(e.scale) : this.scale = new jvm.SimpleScale(e.scale), this.values = e.values ||
    ...
    createRegions: function () {
        ...
        {}, this.params.regionStyle)), jvm.$(t.node).bind("selected", function (e, t) {
